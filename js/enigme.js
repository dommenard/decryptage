									...
									$( ".draggable2, .person, .enfant" ).droppable({
										drop: function( event, ui ) {
											...
											if(sortSuccess){
												...
												$(".solution").html("<div style=”white-space:nowrap;”><svg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' width='1000' height='100'><text x='100' y='-10' font-size='18px' transform='scale(1 -1) skewX(40)'>POUR FINALISER LA DESACTIVATION DU SYSTEME VOUS DEVREZ AJUSTER LES CADRANS SUIVANT</text><text x='130' y='-40' font-size='18px' transform='scale(1 -1) skewX(40)'>LA TRADITION DE LA RUE DES BOULANGERIS LONDONIENNES L ORDONNANCEMENT DOIT</text><text x='160' y='-70' font-size='18px' transform='scale(1 -1) skewX(40)'>TOUTEFOIS RESPECTER LE CMJ ET NON L ENLIGNEMENT TRADITIONNEL DE BABORD A TRIBORD</text></svg></div></div>");
												$(".solution").show();
