									...
									$( ".draggable2, .person, .enfant" ).droppable({
										drop: function( event, ui ) {
											...
											if(sortSuccess){
												...
												$(".solution").html("<div style=”white-space:nowrap;”><svg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' width='1000' height='100'><text x='100' y='-10' transform='scale(1, -1) skewX(40)'>Pour finaliser la désactivation du système, vous devrez ajuster les cadrans suivant</text><text x='130' y='-40' transform='scale(1, -1) skewX(40)'>la tradition de la rue des boulangeris londoniennes. L'ordonnancement doit</text><text x='160' y='-70' transform='scale(1, -1) skewX(40)'>toutefois respecter le cmj et non l'enlignement traditionnel de bâbord à tribord.</text></svg></div></div>");
												$(".solution").show();
